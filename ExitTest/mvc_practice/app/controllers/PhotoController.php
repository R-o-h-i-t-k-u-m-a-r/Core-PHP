...
class PhotoController {
    ...
    public function index() {
        ...
        include 'C:\xampp\htdocs\mvc_practice\app\views\photo_list.php';
    }
    ...
    public function add() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            include 'C:\xampp\htdocs\mvc_practice\app\views\add_photo.php';
        }
    }
    ...
    {
        $photo=$this->model->getPhotoById($id);
        include 'C:\xampp\htdocs\mvc_practice\app\views\delete_photo.php';
    }
